...
public class Game extends Canvas implements Runnable
{
	...
	public static final String name = "The Well";

	public static final int nativeWidth = 800;
	public static final int nativeHeight = 450;
	...
	public void run()
	{
		...
		while (running)
		{
			...
			if (System.currentTimeMillis() - lastTimer >= 1000)
			{
				...
				System.out.println(ticks + " ticks, " + frames + " fps, " + level.tickCount/60 + " seconds");
				frames = 0;
				ticks = 0;
			}
		}
